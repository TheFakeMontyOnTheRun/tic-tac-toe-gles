...
#import "TicTacToeGLView.h"
#import "OpenGLRenderer.h"

#define SUPPORT_RETINA_RESOLUTION 1

@interface TicTacToeGLView ()
{
    OpenGLRenderer* _renderer;
}
@end

@implementation TicTacToeGLView
...
{
    CVReturn result = [(__bridge TicTacToeGLView*)displayLinkContext getFrameForTime:outputTime];
    return result;
}
