...
#import "TicTacToeWindowController.h"
#import "TicTacToeFullscreenWindow.h"

@interface TicTacToeWindowController ()
{
    // Fullscreen window
    TicTacToeFullscreenWindow *_fullscreenWindow;
...
@implementation TicTacToeWindowController
...
- (void) goFullscreen
{
	...
	_fullscreenWindow = [[TicTacToeFullscreenWindow alloc] init];
